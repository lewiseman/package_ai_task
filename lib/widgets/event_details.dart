          ...
          if (dateTimes.start != null || dateTimes.end != null)
            Row(
              children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text('Date'),
                                      Text(
                                        dateTimes.start?.humanWordsDate ?? '',
                                      ),
                                    ],
                                  ),
                                ],
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text('Time'),
                                      Text(dateTimes.start?.humanTime ?? ''),
                                    ],
                                  ),
                                ],
                              ),
                ...
                if (dateTimes.end != null && dateTimes.start != null)
                  SizedBox(width: 16),
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text('Date'),
                                      Text(dateTimes.end?.humanWordsDate ?? ''),
                                    ],
                                  ),
                                ],
                              ),
